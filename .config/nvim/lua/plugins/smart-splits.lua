return {
  ...
  config = function()
    ...
    vim.keymap.set('n', '<C-h>', require('smart-splits').swap_buf_left, { desc = 'Swap with window to left' })
    vim.keymap.set('n', '<C-l>', require('smart-splits').swap_buf_right, { desc = 'Swap with window to right' })
    vim.keymap.set('n', '<C-j>', require('smart-splits').swap_buf_down, { desc = 'Swap with window below' })
    vim.keymap.set('n', '<C-k>', require('smart-splits').swap_buf_up, { desc = 'Swap with window above' })
  end,
}
